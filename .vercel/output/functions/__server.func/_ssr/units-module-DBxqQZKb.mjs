...
import { B as supabase, I as fetchUnits, K as updateUnit, L as fetchViewTypes, N as fetchRentFrequencies, P as fetchSecurityDepositTypes, S as fetchLeaseStatuses, _ as fetchFurnishingTypes, c as createUnit, f as fetchAllProperties, l as createUnitRooms, w as fetchMaintenanceResponsibilities } from "./supabase-y7n1teoy.mjs";
import { c as require_jsx_runtime } from "../_libs/@radix-ui/react-arrow+[...].mjs";
import { u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
import { At as FileSpreadsheet, G as Plus, Lt as Droplets, Zt as CirclePlus, an as ChevronLeft, bn as BedDouble, ct as LoaderCircle, gn as Building2, h as TriangleAlert, in as ChevronRight, kt as FileText, n as X, s as Users, sn as Check, t as Zap, v as Trash2, vt as House, w as Snowflake, xn as Bath } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/units-module-DBxqQZKb.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsContent, {
						value: "property",
						className: "m-0",
						children: properties.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
							className: "border-border",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
								className: "flex flex-col items-center justify-center py-12 text-center text-muted-foreground",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Building2, { className: "mb-2 h-8 w-8 text-muted-foreground/50" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-xs",
										children: "Add properties first to manage units."
									})
								]
							})
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardHeader, {
								...
								children: unitsByProperty.map((p) => {
									...
									return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												children: p.total === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-amber-600 dark:text-amber-400 font-medium",
													children: "0 units added"
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "mt-0.5 text-right text-xs font-semibold text-muted-foreground",
												children: p.total > 0 ? `${rate}%` : "0%"
											})
										]
									}, p.id);
								})
