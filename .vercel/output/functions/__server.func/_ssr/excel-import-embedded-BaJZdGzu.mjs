...
import { A as ShieldCheck, F as Search, Jt as CircleX, Lt as Download, Nt as Eye, Qt as CircleCheck, Ut as CloudUpload, Wt as Clock, h as TriangleAlert, kt as FileSpreadsheet, st as LoaderCircle } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/excel-import-embedded-BaJZdGzu.js
...
function ExcelImportEmbedded({ module, defaultOperation = "CREATE", title, description, onCompleted, hideHistory = false }) {
	...
	const filteredRecords = (0, import_react.useMemo)(() => {
		...
		return currentBatch.records.filter((rec) => {
			...
			return rec.recordKey.toLowerCase().includes(search) || rec.recordName && rec.recordName.toLowerCase().includes(search) || Object.values(rec.rawRowData || {}).some((val) => String(val).toLowerCase().includes(search)) || rec.errors.some((e) => e.message.toLowerCase().includes(search));
		});
	}, [
		currentBatch,
		previewTab,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								}) }) : filteredRecords.slice(0, 50).map((record) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
