...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.masters-C3KJMWbV.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var MastersModule = (0, import_react.lazy)(() => import("./masters-module-GJ7hjaaJ.mjs").then((m) => ({ default: m.MastersModule })));
