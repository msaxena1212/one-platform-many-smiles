...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.masters-Lvs53bue.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var MastersModule = (0, import_react.lazy)(() => import("./masters-module-DzvRqiSa.mjs").then((m) => ({ default: m.MastersModule })));
