...
//#region node_modules/.nitro/vite/services/ssr/assets/prop-mgr.finance-Dh_W9Jda.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var FinanceModule = (0, import_react.lazy)(() => import("./finance-module-BuTE3csG.mjs").then((m) => ({ default: m.FinanceModule })));
