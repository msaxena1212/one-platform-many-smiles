...
import { A as ShieldCheck, B as RefreshCw, Cn as Award, F as Search, J as PenLine, Nt as Eye, Ot as FileText, Qt as CircleCheck, U as Printer, V as Receipt, Vt as CreditCard, W as Plus, Wt as Clock, Yt as CircleQuestionMark, at as LogOut, c as User, dn as Calendar, f as UserCheck, hn as Building2, in as ChevronLeft, k as Shield, kt as FileSpreadsheet, nt as Megaphone, p as Upload, rn as ChevronRight, rt as MapPin, s as Users, v as Trash2, wt as GitBranch, yt as HeartHandshake, zt as DollarSign } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/hrms-module-CT4alH1M.js
...
var HrmsMastersApi = {
	...
	async getEmployeeCreationMasters() {
		const [companies, branches, entities, businessUnits, departments, subDepartments, designations, grades, employmentTypes, contractTypes, countries, states, cities, banks] = await Promise.all([
...
function EmployeeOnboardingWizard({ open, onOpenChange, onSuccess, employeeToEdit }) {
	...
	(0, import_react.useEffect)(() => {
		...
		if (open) {
			initMasters();
			if (!employeeToEdit) {
				const generatedCode = "EMP-" + Math.floor(1e3 + Math.random() * 9e3);
				setBasic((prev) => ({
					...prev,
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Gross Estimated Monthly CTC" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												className: "text-base font-bold",
												children: [(payment.basic_salary + payment.hra + payment.tra).toLocaleString(), " QAR"]
											})]
										})
									]
								})
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											className: "font-semibold text-xs",
											children: selectedEmployeeProfile.nationality || "Qatari"
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "p-3 rounded-lg border bg-card",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-[11px] text-muted-foreground block font-medium",
											children: "Monthly CTC Salary"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											className: "font-bold text-xs text-emerald-600",
											children: [(Number(selectedEmployeeProfile.basic_salary || 0) + Number(selectedEmployeeProfile.hra || 0) + Number(selectedEmployeeProfile.tra || 0)).toLocaleString(), " QAR"]
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "p-3 rounded-lg border bg-card",
