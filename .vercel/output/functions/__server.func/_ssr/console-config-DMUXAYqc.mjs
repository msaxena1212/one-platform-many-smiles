...
import { A as ShieldCheck, At as FilePenLine, B as RefreshCw, Bt as Database, Cn as Award, Ct as Globe, Gt as ClipboardList, I as Scale, M as Settings, Ot as FileText, Rt as DoorOpen, V as Receipt, Vt as CreditCard, Wt as Clock, X as Package, Xt as CirclePlus, Zt as CircleMinus, _ as TrendingDown, _n as BookOpen, _t as House, at as LogOut, cn as ChartPie, dn as Calendar, f as UserCheck, ft as Landmark, g as TrendingUp, gn as Box, gt as Inbox, h as TriangleAlert, hn as Building2, j as ShieldAlert, jn as Activity, jt as FileCheck, kn as ArrowLeftRight, kt as FileSpreadsheet, lt as LayoutDashboard, m as Truck, nt as Megaphone, o as Wallet, ot as Lock, pt as Key, r as Wrench, rt as MapPin, s as Users, un as ChartColumn, ut as Layers, vn as Bell, wt as GitBranch, xn as Banknote, y as Ticket, zt as DollarSign } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/console-config-DMUXAYqc.js
				...
				groups: [
					{
						...
						items: [
							...
							{
								to: "/admin/masters",
								search: { tab: "department" },
								label: "Department",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Building2, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "designation" },
								label: "Designation",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserCheck, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "employment_type" },
								label: "Employment Type",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Award, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "work_location" },
								label: "Work Location",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "employee_status" },
					...
					},
					{
						...
						items: [
							{
								to: "/admin/masters",
								search: { tab: "property_type" },
								label: "Property Type",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Building2, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "property_category" },
								label: "Property Category",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layers, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "property_status" },
							...
							{
								to: "/admin/masters",
								search: { tab: "vat_tax_treatment" },
								label: "VAT / Tax Treatment",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Receipt, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "amenities_facilities" },
								label: "Amenities / Facilities",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, { className: "h-3.5 w-3.5" })
							}
						]
					},
					{
						...
						items: [
							{
								to: "/admin/masters",
								search: { tab: "unit_type" },
								label: "Unit Type",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DoorOpen, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "unit_usage" },
								label: "Unit Usage",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LayoutDashboard, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "bedroom_count" },
								label: "Bedrooms",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(House, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "bathroom_count" },
								label: "Bathrooms",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(House, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "view_type" },
								label: "View Types",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Globe, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "furnishing" },
								label: "Furnishing",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "unit_status" },
								label: "Unit Status",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Activity, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "lease_status" },
								label: "Lease Status",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "rent_frequency" },
								label: "Rent Frequency",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "maintenance_responsibility" },
								label: "Maintenance Responsibility",
								icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Wrench, { className: "h-3.5 w-3.5" })
							},
							{
								to: "/admin/masters",
								search: { tab: "security_deposit_type" },
