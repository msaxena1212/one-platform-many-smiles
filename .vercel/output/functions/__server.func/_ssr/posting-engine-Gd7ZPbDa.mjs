...
//#region node_modules/.nitro/vite/services/ssr/assets/posting-engine-Gd7ZPbDa.js
/**
...
async function postVoucher(input) {
	...
	const { createAccountingEvent } = await import("./accounting-event-engine-BNKlssam.mjs").then((n) => n.t).then((n) => n.t);
