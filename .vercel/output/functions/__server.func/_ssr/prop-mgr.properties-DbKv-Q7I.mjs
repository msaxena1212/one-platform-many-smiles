...
//#region node_modules/.nitro/vite/services/ssr/assets/prop-mgr.properties-DbKv-Q7I.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var PropertiesModule = (0, import_react.lazy)(() => import("./properties-module-CZ6XszIa.mjs").then((m) => ({ default: m.PropertiesModule })));
