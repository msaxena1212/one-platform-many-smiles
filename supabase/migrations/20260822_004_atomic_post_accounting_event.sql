...
begin
    ...
    /*
     * ============================================================
     * 6. Check for existing voucher
     * ============================================================
     *
     * This handles a voucher that may already exist from
     * a previous attempt.
     */
    ...
    from fin_accounting_event_lines l

    left join fin_coa_accounts coa
        on coa.account_code = l.account_code
