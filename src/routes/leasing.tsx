...
import { LayoutDashboard, LogOut, Briefcase, FileSignature, PlusCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-muted/30 flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-background border-r border-border hidden md:flex flex-col">
        <div className="p-6 border-b border-border flex items-center gap-3">
          ...
          <span className="font-semibold text-lg tracking-tight">Leasing Dashboard</span>
        </div>
