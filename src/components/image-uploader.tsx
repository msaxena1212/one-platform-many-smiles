...
export function ImageUploader({ images, onChange, categories, disabled = false }: ImageUploaderProps) {
              ...
              <div className="aspect-square relative">
                ...
                {disabled && img.isCover && (
                  <div className="absolute top-2 left-2">
                    <Badge variant="secondary" className="bg-background/80 text-[10px]">Cover Photo</Badge>
                  </div>
                )}
              </div>
            </Card>
