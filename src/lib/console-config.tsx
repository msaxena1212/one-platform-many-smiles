...
const consoleConfigs: Record<ConsoleKey, ConsoleConfig> = {
  ...
  admin: {
    ...
    nav: [
      ...
      { to: "/admin/assets", label: "Assets", icon: <Package className="h-4 w-4" /> },
      { to: "/admin/hrms", label: "HRMS", icon: <Users className="h-4 w-4" /> },
      { to: "/admin/users", label: "Users", icon: <Users className="h-4 w-4" /> },
      { to: "/admin/permissions", label: "Permissions", icon: <ShieldCheck className="h-4 w-4" /> },
      { to: "/admin/masters", label: "Masters", icon: <Settings className="h-4 w-4" /> },
    ...
    titleRules: [
      ...
      { match: "/admin/masters", title: "Masters" },
